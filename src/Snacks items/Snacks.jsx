...
const Snacks = () => {
  return (
    ...
    < div className="flex flex-wrap p-2 m-0 relative box-border">
      {
        snack.map((data) => (
          <div key={data.id} className={`${data.cls} flex flex-col items-center p-12 ml-12`}
          >
            ...
            <div className="mt-5 ml-12">
              ...
              <button className="cursor-pointer bg-white text-blue-700 hover:text-black rounded-xl px-4 py-2 border-2 border-blue-500 transition duration-200"
